...
<table style="color: yellow;" class="table table-dark table-hover" border="2px">
	...
	<tr>
         ...
         <td><img src="/images/{{$student->photo}}" height="80px" width="80px"> </td>
     ...
     <td>
   <button class="btn btn-success"><a style="color: white;" href="{{route('student.edit',$student->Studid)}}">edit</a></button>
     </td>
         <td>
